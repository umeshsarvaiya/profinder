        ...
        >
              ...
              <Tooltip title="Clear all filters">
                <Button
                  ...
                  sx={{
                    borderRadius: 2,
                    py: 1.5,
                    borderColor: hasActiveFilters ? 'error.main' : 'grey.300',
                    color: hasActiveFilters ? 'error.main' : 'text.secondary',
                    '&:hover': {
                      borderColor: hasActiveFilters ? 'error.dark' : 'grey.300',
                      backgroundColor: hasActiveFilters ? 'error.50' : 'transparent'
                    }
                  }}
                >
                  Clear
          ...
          {hasActiveFilters && (
            <Box sx={{ mt: 3, display: 'flex', flexWrap: 'wrap', gap: 1 }}>
              ...
              {selectedProfession && (
                <Chip
                  label={`Profession: ${selectedProfession}`}
                  onDelete={() => setSelectedProfession('')}
                  size="small"
                  color="primary"
                  variant="outlined"
                />
          ...
          <Box sx={{ mt: 2, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Typography variant="body2" color="text.secondary">
              Showing {filteredAdmins.length} of {verifiedAdmins.length} professionals
            </Typography>
            {hasActiveFilters && (
